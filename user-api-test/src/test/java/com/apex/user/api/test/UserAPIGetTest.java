...
public class UserAPIGetTest extends ApexBaseTest implements UserConstant {

	@DataProvider(name = "getUserIds_dp")
	public Object[][] getUserIds() throws Exception {
		//String[][] userIds = { { "10", "Byron"}, { "11", "George"}, { "12", "Rachel" } };
		String[][] userIds=JXLUtil.getData("C:\\Users\\anand\\Desktop\\Data_testing\\user_api_test_data.xls","Sheet1","Userids_successful");
		return userIds;
	}
